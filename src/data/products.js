...
const sharedApplications = [
  {
    ...
    description: 'For project environments that require organized electrical distribution and manufacturing support.',
  },
  {
    id: 'commercial-technical',
    title: 'Commercial technical facilities',
    description: 'For facilities that need dependable panel, cabinet, or distribution-system coordination.',
  },
]
...
export const products = [
  {
    ...
    gallery: [
      {
        ...
        caption: 'Medium-voltage switchgear category visual from ERCON public assets.',
      },
      {
        id: 'mv-manufacturing',
        src: generatedHero,
        alt: 'Switchgear manufacturing floor with blue panels',
        caption: 'Manufacturing environment used as a temporary product-context visual.',
      },
    ],
    highlights: ['Medium voltage', 'Type-tested focus', 'Protection and control'],
    features: [
      {
        id: 'control-protection',
        title: 'Control and protection role',
        description: 'Positioned for controlling and protecting electrical equipment in medium-voltage power systems.',
      },
      {
        id: 'manufacturing-focus',
        title: 'Manufacturing-focused delivery',
        description: 'Connected to ERCON’s LV/MV switchgear manufacturing and power-distribution capability.',
      },
    ],
    ...
    specifications: makeSpecifications([
      ...
      { label: 'Functional role', value: 'Control and protection of electrical equipment' },
      { label: 'Detailed ratings', value: 'To be confirmed from ERCON technical documentation' },
    ]),
    relatedProductSlugs: ['medium-voltage-switchgear', 'low-voltage-switchgear', 'cable-management-system'],
    featured: true,
    status: 'active',
  },
  {
    ...
    highlights: ['Power distribution', 'Industrial projects', 'System reliability'],
    features: [
      {
        id: 'distribution-support',
        title: 'Distribution system support',
        description: 'Part of ERCON’s medium-voltage product range for electrical distribution requirements.',
      },
      {
        id: 'project-fit',
        title: 'Project-oriented product family',
        description: 'Presented for industrial and infrastructure projects requiring engineered electrical equipment.',
      },
    ],
    applications: sharedApplications,
    specifications: makeSpecifications([
    ...
    relatedProductSlugs: ['mv-type-tested-switchgear', 'low-voltage-switchgear', 'sheet-metal-fabrication'],
    featured: true,
    status: 'active',
  },
  {
    ...
    features: [
      {
        ...
        description: 'Aligned with ERCON’s public positioning around LV/MV switchgear and electrical panels.',
      },
      {
        id: 'distribution-control',
        title: 'Distribution control',
        description: 'Supports electrical distribution and control requirements in project environments.',
      },
    ],
    applications: sharedApplications,
    specifications: makeSpecifications([
      ...
      { label: 'Related manufacturing', value: 'Electrical panels and cabinets' },
    ]),
    relatedProductSlugs: ['medium-voltage-switchgear', 'mv-type-tested-switchgear', 'sheet-metal-fabrication'],
    featured: true,
    status: 'active',
  },
  {
    ...
    features: [
      {
        ...
        description: 'Included in ERCON’s public product range beside switchgear and cable-management solutions.',
      },
    ],
    applications: [
      {
        ...
        description: 'For projects evaluating solar energy systems as part of broader electrical infrastructure.',
      },
    ],
    specifications: makeSpecifications([
      { label: 'Product family', value: 'Solar energy systems' },
      { label: 'Category', value: 'Energy Solutions' },
      { label: 'Detailed system ratings', value: 'To be confirmed from ERCON technical documentation' },
    ]),
  ...
  },
  {
    ...
    features: [
      {
        ...
        description: 'Supports cable tray and cable-management requirements for maintainable installations.',
      },
      {
        id: 'fabrication-link',
        title: 'Manufacturing link',
        description: 'Connected to ERCON’s sheet metal fabrication and electrical manufacturing capabilities.',
      },
    ],
    applications: sharedApplications,
    specifications: makeSpecifications([
    ...
    relatedProductSlugs: ['sheet-metal-fabrication', 'low-voltage-switchgear', 'solar-energy-systems'],
    featured: true,
    status: 'active',
  },
  {
    ...
    features: [
      {
        ...
        description: 'Supports electrical cabinets, enclosures, and switchgear production requirements.',
      },
      {
        id: 'manufacturing-capability',
        title: 'Production capability',
        description: 'Part of ERCON’s localized manufacturing capability in Pakistan.',
      },
    ],
    applications: sharedApplications,
    specifications: makeSpecifications([
      ...
      { label: 'Related products', value: 'Electrical cabinets, switchgear, cable management' },
    ]),
    relatedProductSlugs: ['cable-management-system', 'low-voltage-switchgear', 'medium-voltage-switchgear'],
    featured: true,
    status: 'active',
  },
]
...
export const getRelatedProducts = (product, limit = 3) => {
  ...
  const sameCategory = products.filter(
    (candidate) => candidate.slug !== product.slug && candidate.categoryId === product.categoryId,
  )
