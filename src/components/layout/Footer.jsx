        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.6fr_1fr_1fr_1fr] border-b border-white/10 pb-12">
          ...
          <div>
            ...
            <ul className="space-y-3.5 text-sm">
              <li>
                <a href="https://www.facebook.com/people/ERCON-Industries-PVT-Limited/61591925099821/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 text-white/60 hover:text-white transition-all duration-200 group">
              ...
              <li>
                <a href="https://www.instagram.com/ercon.ind/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 text-white/60 hover:text-white transition-all duration-200 group">
              ...
              <li>
                <a href="https://www.linkedin.com/company/ercon-industries-pvt-limited" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 text-white/60 hover:text-white transition-all duration-200 group">
